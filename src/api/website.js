...
export const fetchWebsites = () => {
  return fetch(`${BASE_URL}/api/websites`).then((response) => {
    if (!response.ok) {
...
export const fetchWebsiteById = (id) => {
  return fetch(`${BASE_URL}/api/websites/${id}`).then((response) => {
    if (!response.ok) {
...
export const createWebsite = (websiteData) => {
  return fetch(`${BASE_URL}/api/websites`, {
    method: "POST",
    headers: {
...
export const updateWebsite = (id, websiteData) => {
  return fetch(`${BASE_URL}/api/websites/${id}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
    },
